...
namespace SchoolMS.Controllers
{
    public class ClubsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClubId,Name,NumberOfMembers,Patron,Description,ChairPerson")] Club club)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClubId,Name,NumberOfMembers,Patron,Description,ChairPerson")] Club club)
        {
            if (id != club.ClubId)
            {
                return NotFound();
