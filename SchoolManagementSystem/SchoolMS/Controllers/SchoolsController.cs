...
namespace SchoolMS.Controllers
{
    public class SchoolsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code,ChairPerson")] School school)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Code,ChairPerson")] School school)
        {
            if (id != school.Id)
            {
                return NotFound();
